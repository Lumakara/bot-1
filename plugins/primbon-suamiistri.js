...
addLimit(m.sender, global.isPrem(m.sender), isCreator);
    ...
    await Reply("⏳ Sedang meramal hubungan suami istri...")
    ...
    try {
        ...
        let url = `https://api.botcahx.eu.org/api/primbon/suamiistri?apikey=${global.apikeyalip}&nama1=${encodeURIComponent(nama1)}&tanggal1=${tanggal1}&bulan1=${bulan1}&tahun1=${tahun1}&nama2=${encodeURIComponent(nama2)}&tanggal2=${tanggal2}&bulan2=${bulan2}&tahun2=${tahun2}`
...
👨 *Suami:* ${msg.suami.nama}
📅 *Tanggal Lahir:* ${msg.suami.tgl_lahir}

👩 *Istri:* ${msg.istri.nama}
📅 *Tanggal Lahir:* ${msg.istri.tgl_lahir}
...
📝 *Catatan:* ${msg.catatan}`
        ...
        console.error(e)
        return Reply("❌ Terjadi error saat mengambil data ramalan suami istri.")
    }
}

handler.command = ["ramalansuamiistri", "suamiistri"]
