...
addLimit(m.sender, global.isPrem(m.sender), isCreator);
    ...
    await Reply("⏳ Sedang meramal jodoh...")
    ...
    try {
        ...
        let url = `https://api.botcahx.eu.org/api/primbon/ramalanjodoh?apikey=${global.apikeyalip}&nama1=${encodeURIComponent(nama1)}&tanggal1=${tanggal1}&bulan1=${bulan1}&tahun1=${tahun1}&nama2=${encodeURIComponent(nama2)}&tanggal2=${tanggal2}&bulan2=${bulan2}&tahun2=${tahun2}`
...
📝 *Catatan:* ${msg.catatan}`
        ...
        console.error(e)
        return Reply("❌ Terjadi error saat mengambil data ramalan jodoh.")
    }
}

handler.command = ["ramalanjodoh", "jodoh"]
